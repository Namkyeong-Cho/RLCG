...
DQN = DQNAgent(env = None, capacity = capacity_, hidden_dim = hidden_dim_, batch_size = batch_size_, epochs = epochs_,
			   ...
			   cons_num_features = cons_num_features_, vars_num_features = vars_num_features_,
...
total_times, episode_rewards, num_episodes = \
	DQN.learning(schedule_train_name, epsilon = epsilon_,
				 decaying_epsilon = decaying_epsilon_, gamma = gamma_,
				 learning_rate = learning_rate_, max_episode_num = max_episode_num_,
				 display = display_, min_epsilon = min_epsilon_, min_epsilon_ratio = min_epsilon_ratio_,
...
if TEST:
	...
	DQN_test = DQNAgent(env = None, capacity = 20000, hidden_dim = 32, batch_size = 32,
						epochs = 5, embedding_size = 32, cons_num_features = 2,
